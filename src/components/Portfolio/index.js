        ...
        <div id="portfolio-container" className="animate__fadeInUp">
          <div class="card">
            ...
            <div className="content">
              ...
              <h2>MOMENT</h2>
              <p className="tool">
                ReactJS, Redux, Flask, SQLAlchemy, CSS3, AWS
              </p>
              <h3>
                Online social networking website enabling users to generate
                posts, engage in discussions, and create connections.
              </h3>
              <div id="link-div">
          ...
          <div class="card">
            ...
            <div className="content">
              ...
              <h3>
                An online retail platform specializing in the sale of
          ...
          <div class="card">
            ...
            <div className="content">
              ...
              <h3>
                An e-commerce platform dedicated to the sale of designer fashion
                products.{' '}
              </h3>
              <div id="link-div">
          ...
          {/* <div class="card">
            ...
            <div className="content">
              ...
              <h3>
                A MeetUp-inspired event organization platform for organizing
                events for people of similar interests{' '}
              </h3>
              <div id="link-div">
